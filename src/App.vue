<template>
  <div id="app">
    ...
    <main>
      ...
      <section>
        <h3 class="heading">The Playlist</h3>
      </section>
    ...
    return {
      ...
      songs: [
        ...
        },
        {
          title: "Alvida",
          artist: "KK",
          src: require("./assets/Alvida.mp3"),
        },
        {
          title: "Duniya ne Dil",
          artist: "KK",
          src: require("./assets/Duniya ne Dil.mp3"),
        },
        {
          title: "Jhoom Barabar Jhoom",
          artist: "KK",
          src: require("./assets/Jhoom Barabar Jhoom.mp3"),
        },
        {
          title: "Main Tera Dhadkan Teri",
          artist: "KK",
          src: require("./assets/Main Tera Dhadkan Teri.mp3"),
        },
        {
          title: "Mera Pehla Pehla Pyaar",
          artist: "KK",
          src: require("./assets/Mera Pehla Pehla Pyaar.mp3"),
        },
        {
          title: "Tere Bin",
          artist: "KK",
          src: require("./assets/Tere Bin.mp3"),
        },
        {
          title: "Zindagi Do pal",
          artist: "KK",
          src: require("./assets/Zindagi Do Pal Ki.mp3"),
        },
      ],
      player: new Audio(),
    };
